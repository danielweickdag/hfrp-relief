...
import { MapPinIcon, PhoneIcon, EnvelopeIcon, ClockIcon, GlobeAltIcon, HeartIcon } from '@heroicons/react/24/outline';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-white/90">
              ...
              want to volunteer, or need assistance, our team is here to help.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+12242170230" className="hover:text-blue-600 transition-colors">
                        (224) 217-0230
                      </a>
                    </p>
            ...
            {/* Social Media Links */}
            <div className="bg-white rounded-xl shadow-lg p-8 transform transition-all hover:shadow-xl">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Follow Our Impact</h2>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
              <h3 className="text-xl font-bold text-blue-900 mb-4">How quickly will I receive a response?</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
              <h3 className="text-xl font-bold text-blue-900 mb-4">Can I visit your offices in Haiti?</h3>
              <p className="text-blue-800 mb-4">
                We welcome visitors to our Haiti offices. Please schedule an appointment
                in advance to ensure someone is available to meet with you.
              </p>
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <p className="text-blue-900 font-medium">Scheduled visits include:</p>
