    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-red-600 py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Test Mode Notice */}
          {process.env.NEXT_PUBLIC_DONATION_TEST_MODE === 'true' && (
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Small daily amounts create an immediate, life-changing impact for families in Haiti
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              ...
              <p className="text-yellow-800 leading-relaxed">
                At 50 cents per day, you're not just providing a meal - you're investing in a child's entire future.
                This amount ensures comprehensive support including nutrition, education, and healthcare that creates
                lasting change in a young life. Every 50 cents builds hope, dignity, and opportunity.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Every contribution makes a difference. Choose any amount that feels right for you.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-red-600 rounded-xl shadow-lg p-8 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Predictable Support</h3>
                <p className="text-blue-100 text-sm">
                  Monthly gifts help us plan long-term programs and respond quickly to emergencies.
                </p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">💪</div>
                ...
                <p className="text-blue-100 text-sm">
                  Small daily amounts create significant monthly support that transforms communities.
                </p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">❤️</div>
                <h3 className="text-lg font-semibold mb-2">Deeper Connection</h3>
                <p className="text-blue-100 text-sm">
                  Monthly donors receive exclusive updates showing exactly how their gifts are used.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          <div className="bg-gray-100 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              If you experience any issues with the online donation form, you can also contact us directly
              to make your donation or get assistance.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-xl mx-auto">
              <div className="bg-white rounded-lg p-4 shadow">
                <div className="text-2xl mb-2">📧</div>
                <div className="font-semibold">Email Us</div>
                <div className="text-sm text-gray-600">For donation assistance</div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow">
                <div className="text-2xl mb-2">💬</div>
