      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Making a transformative impact on impoverished communities through enhanced healthcare initiatives, accessibility, education, and empowerment.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Our organization is committed to making a transformative impact on impoverished communities through enhanced healthcare initiatives. By focusing on accessibility, education, and empowerment, we aim to break down the barriers that prevent underserved individuals from accessing quality medical services.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-green-600 mb-3">Mobile Clinics</h3>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Regular medical camps and health screenings</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Essential check-ups and preventive care</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Partnerships with local healthcare professionals</span>
                  </li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-green-600 mb-3">Health Education</h3>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Health awareness workshops</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Nutrition and hygiene education</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Disease prevention programs</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-6 rounded">
              <p className="text-gray-700 italic mb-4">
                "The mobile clinic came to our village when my son was very sick. The doctors provided immediate care and taught us how to prevent similar health issues. Today, my son is healthy and strong."
              </p>
              <p className="text-green-600 font-semibold">— Claudette, Mother from Les Cayes</p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-700 mb-6">
              By fostering a holistic approach to healthcare within these communities, we aspire to create a brighter, healthier future for all, ultimately breaking the cycle of poverty and improving overall quality of life.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600 mb-2">$25</div>
                <div className="text-sm text-gray-600">Provides basic medical care</div>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600 mb-2">$75</div>
                <div className="text-sm text-gray-600">Supports a health education workshop</div>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600 mb-2">$150</div>
                <div className="text-sm text-gray-600">Funds a mobile clinic visit</div>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-green-500 to-blue-600 rounded-lg shadow-xl p-8 text-white">
            <h2 className="text-2xl font-bold mb-4">Support Healthcare Access</h2>
            <p className="mb-6">Help us bring essential healthcare services to underserved communities in Haiti.</p>
