...
const reports = [
  {
    ...
    description: 'Comprehensive overview of all program activities including feeding, healthcare, education, and housing initiatives.',
    date: '2024-04-30',
    type: 'Monthly Report',
    pages: 24,
    photos: 18,
  ...
  },
  {
    ...
    description: 'Detailed analysis of our feeding programs showing meal distribution, nutrition impact, and community outcomes.',
    date: '2024-04-15',
    type: 'Program Report',
    pages: 16,
    photos: 11,
  ...
  },
  {
    ...
    description: 'Mobile clinic activities, health screenings, and medical care provided to community members.',
    date: '2024-04-20',
    type: 'Program Report',
    pages: 12,
    photos: 8,
  ...
  },
  {
    ...
    description: 'School supply distribution, educational support, and community development activities.',
    date: '2024-04-25',
    type: 'Program Report',
    pages: 10,
    photos: 6,
...
const financialData = [
  { category: 'Feeding Programs', percentage: 45, amount: '$12,500', color: 'bg-orange-500' },
  { category: 'Healthcare Services', percentage: 25, amount: '$6,950', color: 'bg-green-500' },
  { category: 'Education Support', percentage: 20, amount: '$5,560', color: 'bg-blue-500' },
  { category: 'Housing & Infrastructure', percentage: 10, amount: '$2,780', color: 'bg-purple-500' }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Download detailed reports with photo documentation showing exactly how your donations create positive change in Haitian communities. All reports include financial transparency and program outcomes.
          </p>
        </div>
            ...
            <div>
              ...
              {financialData.map((item) => (
                <div key={item.category} className="mb-4">
                  ...
                  <div className="text-xs text-gray-500 mt-1">{item.percentage}% of total funds</div>
                </div>
              ))}
            </div>
            <div className="bg-blue-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-blue-900 mb-4">Total Impact</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-blue-900">500+ individuals</span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {reports.map((report) => (
            <div key={report.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
                  ...
                  <div className="text-center bg-gray-50 rounded-lg p-3">
                    <div className="font-bold text-gray-900">{report.photos}</div>
                    <div className="text-gray-500">Photos</div>
                  </div>
                  <div className="text-center bg-gray-50 rounded-lg p-3">
                    <div className="font-bold text-gray-900">{report.beneficiaries}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-green-50 rounded-xl p-6 border-l-4 border-green-600">
            <h3 className="text-xl font-bold text-green-900 mb-3">🎯 What's in Each Report</h3>
          ...
          <div className="bg-yellow-50 rounded-xl p-6 border-l-4 border-yellow-600">
            <h3 className="text-xl font-bold text-yellow-900 mb-3">📧 Get Regular Updates</h3>
            <p className="text-yellow-800 text-sm mb-4">
              Subscribe to receive monthly impact reports directly in your inbox. Stay connected with the families you're helping.
            </p>
            <div className="space-y-3">
              <input
                type="email"
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center">
          <div className="bg-blue-100 rounded-xl p-6">
            <h3 className="text-lg font-bold text-blue-900 mb-2">📞 Questions About Our Reports?</h3>
            <p className="text-blue-800 text-sm mb-4">
              We're committed to complete transparency. If you have any questions about our programs, finances, or impact documentation, please reach out.
            </p>
            <Link
              href="/contact"
