...
const DEFAULT_SETTINGS: NotificationSettings = {
  ...
  defaultMethod: "email",
  emailSettings: {
    fromEmail: "noreply@familyreliefproject7.org",
    fromName: "HFRP Admin System",
    replyTo: "admin@familyreliefproject7.org",
  },
  notificationTypes: {
    blog_published: {
      enabled: true,
      priority: "medium",
      methods: ["email"],
      recipients: ["admin@familyreliefproject7.org"],
    },
    blog_scheduled: {
      enabled: true,
      priority: "low",
    ...
    blog_needs_review: {
      ...
      methods: ["email"],
      recipients: [
        "admin@familyreliefproject7.org",
        "editor@familyreliefproject7.org",
      ],
    },
    user_created: {
      enabled: true,
    ...
    volunteer_joined: {
      ...
      priority: "medium",
      methods: ["email"],
      recipients: ["volunteer@familyreliefproject7.org"],
    },
    ...
    donation_received: {
      ...
      recipients: [
        "admin@familyreliefproject7.org",
        "finance@familyreliefproject7.org",
      ],
    },
    backup_completed: {
      enabled: true,
  ...
  steps: [
    {
      ...
      requiredApprovals: 1,
      autoApproveAfter: 48,
      escalateTo: ["admin@familyreliefproject7.org"],
    },
  ],
