...
const DEFAULT_SETTINGS: NotificationSettings = {
  ...
  defaultMethod: "email",
  emailSettings: {
    fromEmail: "noreply@familyreliefproject.org",
    fromName: "HFRP Admin System",
    replyTo: "admin@familyreliefproject.org",
  },
  notificationTypes: {
    blog_published: {
      enabled: true,
      priority: "medium",
      methods: ["email"],
      recipients: ["admin@familyreliefproject.org"],
    },
    blog_scheduled: {
      enabled: true,
      priority: "low",
    ...
    blog_needs_review: {
      ...
      methods: ["email"],
      recipients: [
        "admin@familyreliefproject.org",
        "editor@familyreliefproject.org",
      ],
    },
    user_created: {
      enabled: true,
    ...
    volunteer_joined: {
      ...
      priority: "medium",
      methods: ["email"],
      recipients: ["volunteer@familyreliefproject.org"],
    },
    ...
    donation_received: {
      ...
      recipients: [
        "admin@familyreliefproject.org",
        "finance@familyreliefproject.org",
      ],
    },
    backup_completed: {
      enabled: true,
  ...
  steps: [
    {
      ...
      requiredApprovals: 1,
      autoApproveAfter: 48,
      escalateTo: ["admin@familyreliefproject.org"],
    },
  ],
