...
export default function MembershipPage() {
  ...
  const membershipCampaignId = process.env.NEXT_PUBLIC_DONORBOX_MEMBERSHIP_CAMPAIGN || "haitian-family-relief-membership";
  ...
  return (
    <section className="max-w-3xl mx-auto py-10">
      ...
      <p className="text-center text-lg mb-8 text-zinc-700">
        Join our family of recurring supporters! Choose a monthly or yearly plan and make a difference every day.
      </p>

      {isTestMode && (
        <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-6 text-center">
          <strong>TEST MODE:</strong> This is a test membership form. No real charges will be processed.
        </div>
      )}
      ...
      <div className="text-xs text-center text-zinc-400 mt-6">
        Memberships are securely handled via Donorbox monthly/yearly recurring giving options.
      </div>
    </section>
  );
}
