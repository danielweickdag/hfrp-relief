...
export default function DeploymentChecklist() {
  ...
  const runChecks = async () => {
    ...
    checklist.push({
      ...
      status: localStorage.getItem("hfrp_site_settings")?.includes("G-")
        ? "complete"
        : "warning",
    });
    ...
    checklist.push({
      ...
      status: localStorage.getItem("hfrp_backup_history")
        ? "complete"
        : "warning",
    });
    ...
    checklist.push({
      ...
      status:
        (localStorage.getItem("hfrp_blog_posts")?.length ?? 0) > 10
          ? "complete"
          : "warning",
    });
    ...
    checklist.push({
      ...
      status: localStorage.getItem("hfrp_volunteer_programs")
        ? "complete"
        : "warning",
    });
          ...
          {errorCount > 0 && (
            <div className="mt-4 p-4 bg-red-50 rounded-md">
              <p className="text-red-800 font-medium">
                ✗ {errorCount} critical issues must be resolved before
                deployment.
              </p>
            </div>
          )}
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded">
            ...
            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
              <li>
                Ensure all environment variables are set in your hosting
                platform
              </li>
              <li>
                Test the donation flow with Stripe test cards before going live
              </li>
