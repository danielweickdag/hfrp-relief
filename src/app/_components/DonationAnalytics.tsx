...
export default function DonationAnalytics() {
  ...
  useEffect(() => {
    ...
    const mockMetrics: DonationMetrics = {
      ...
      retentionRate: 78.5,
      topCampaigns: [
        { name: "Daily Giving Program", amount: 35240.5, percentage: 41.2 },
        { name: "Emergency Relief Fund", amount: 22180.25, percentage: 26.0 },
        { name: "Education Support", amount: 15420.75, percentage: 18.1 },
        { name: "Healthcare Initiative", amount: 12579.0, percentage: 14.7 },
      ],
    };
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Track and analyze donation performance
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                {formatCurrency(metrics.totalDonations)}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-sm p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                {metrics.donorCount.toLocaleString()}
              </p>
            </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredTransactions.map((transaction) => (
                <tr key={transaction.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusBadge(transaction.status)}`}
                    >
                      {transaction.status}
                    </span>
                  </td>
