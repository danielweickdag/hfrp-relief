      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            <div className="text-center">
              <p className="text-gray-700 mb-4 italic text-sm sm:text-base">
                "My children now have full bellies and bright futures. The
                school supplies and daily meals from HFRP changed everything for
                our family."
              </p>
              <div className="font-semibold text-gray-900">Wideline Joseph</div>
              <div className="text-gray-500 text-sm">
                Mother of 3, Cap-Haïtien
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="text-center">
              <p className="text-gray-700 mb-4 italic">
                "When I got sick, HFRP's mobile clinic saved my life. The
                doctors came to our village when no one else would."
              </p>
              <div className="font-semibold text-gray-900">
                Jean-Baptiste Pierre
              </div>
              <div className="text-gray-500 text-sm">
                Farmer, Artibonite Valley
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="text-center">
              <p className="text-gray-700 mb-4 italic">
                "HFRP doesn't just give food - they teach us dignity. They work
                with us, not for us. This is real partnership."
              </p>
              <div className="font-semibold text-gray-900">
                Marie-Claire Duval
              </div>
              <div className="text-gray-500 text-sm">
                Community Leader, Port-au-Prince
              </div>
            </div>
          </div>
        </div>
