...
export const socialContent = {
  mission: "Fighting hunger, providing hope. Together, we feed and empower Haitian orphans. Join our mission! 🇭🇹❤️",
  impact: "Your support transforms lives! 850+ meals served daily, 300+ children in school, 5 community centers strong! 💪",
  donate: "16¢ a day = 1 week of meals for a child. Small daily commitment, HUGE impact! Start your daily giving today! 🍽️",
  education: "Education breaks the cycle of poverty. See how we're empowering children with knowledge and hope! 📚✨",
  healthcare: "Healthcare is a human right. Our mobile clinics bring medical care to those who need it most! 🏥❤️"
};
