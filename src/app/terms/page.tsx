        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              By accessing and using the Haitian Family Relief Project website
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              The Haitian Family Relief Project is a charitable organization
              dedicated to providing aid, support, and resources to Haitian
              families and orphans. Our website provides information about our
              mission, programs, and facilitates donations to support our cause.
            </p>
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              materials on the Haitian Family Relief Project website for
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              to support our charitable mission. By making a donation, you agree
              that:
            </p>
            <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              We use third-party payment processors to handle financial
              transactions. By making a donation, you agree to the terms and
              conditions of our payment processors. We do not store your
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              If you set up recurring donations, you authorize us to charge your
              payment method on the specified schedule until you cancel. You may
              cancel recurring donations at any time by contacting us or through
              your donor account.
            </p>
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              ...
              graphics, images, logos, and software, is the property of the
              Haitian Family Relief Project and is protected by copyright and
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
              If you submit content to our website (such as comments,
              testimonials, or feedback), you grant us a non-exclusive,
              royalty-free, perpetual, and worldwide license to use, modify, and
              display such content. You represent that:
            </p>
            <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              ...
              To the fullest extent permitted by law, this organization excludes
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              In no event shall the Haitian Family Relief Project, nor its
              directors, employees, partners, agents, suppliers, or affiliates,
              be liable for any indirect, incidental, punitive, consequential,
              or special damages arising out of or related to your use of the
              service.
            </p>
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              You agree to defend, indemnify, and hold harmless the Haitian
              Family Relief Project and its affiliates from and against any and
            ...
            <p className="mb-6 text-gray-700 leading-relaxed">
              ...
              United States and the state in which our organization is
