  ...
  const posts: Post[] = [
    {
      ...
      date: "2024-12-15",
      summary: "This month we opened our doors to 30 more children who needed safe shelter and care. Each child now has a bed, regular meals, and access to education.",
      author: "HFRP Team",
    ...
    },
    {
      ...
      date: "2024-12-10",
      summary: "Our feeding program has expanded to serve 500 additional children daily in three new schools across Port-au-Prince.",
    ...
    },
    {
      ...
      date: "2024-12-05",
      summary: "We're grateful for the commitment of our new recurring donors who have joined our Silver and Gold membership tiers this month.",
      author: "HFRP Team",
    ...
    },
    {
      ...
      date: "2024-11-28",
      summary: "Our mobile medical clinic has established a permanent location in Jacmel, providing healthcare access to over 1,000 families.",
    ...
    },
    {
      ...
      date: "2024-11-20",
      summary: "95% of children in our education program have improved their reading skills, with 80% advancing to the next grade level.",
    ...
    },
    {
      ...
      date: "2024-11-15",
      summary: "Thanks to new equipment and additional staff, our community kitchen now serves 850 meals daily, up from 400 just six months ago.",
      author: "Chef Antoine",
    ...
    },
    {
      ...
      date: "2024-11-08",
      summary: "25 community volunteers graduated from our leadership training program, becoming certified to lead programs in their villages.",
      author: "HFRP Team",
    ...
    },
    {
      ...
      date: "2024-10-30",
      summary: "Two new water wells were completed this month, providing clean drinking water access to families in remote areas.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Follow our journey as we transform lives in Haiti. Read about our impact,
            meet the children we serve, and stay updated on our latest programs and achievements.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center mb-6">
            <p className="text-gray-600 mb-4">
              Stay connected with us on social media for daily updates, behind-the-scenes moments,
              and real-time stories from Haiti.
            </p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>Share our stories and help us reach more supporters: #HaitianFamilyRelief #Hope4Haiti</p>
          </div>
        </div>
      </div>
    </div>
