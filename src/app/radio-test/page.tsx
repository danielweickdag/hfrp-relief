...
import RadioPlayer from "../_components/RadioPlayer";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          ...
          <p className="text-gray-600 mb-6">
            This page tests the radio streaming functionality with the new token refresh mechanism 
            to prevent ERR_ABORTED errors from Zeno.fm token expiration.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-blue-800 space-y-1 text-sm">
              <li>• Automatic token refresh every 45 seconds (before 60s expiry)</li>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <p className="text-gray-600 mb-6">
            Testing HLS format which may provide better stability for some browsers.
          </p>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <p className="text-green-800 text-sm">
              ...
              real-time logging of token refresh and stream management.
            </p>
          </div>
        </div>
      </div>
