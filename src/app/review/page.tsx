...
export default function ReviewPage() {
  const [reviewItems, setReviewItems] = useState<ReviewItem[]>([
    // Content Review
    {
      id: "1",
      category: "Content",
      item: "Homepage messaging and mission statement",
      status: "pending",
    },
    {
      id: "2",
      category: "Content",
      item: "Daily giving messaging (16¢, 33¢, 50¢, 66¢ per day)",
      status: "pending",
    },
    {
      id: "3",
      category: "Content",
      item: "About Us page accuracy",
      status: "pending",
    },
    {
      id: "4",
      category: "Content",
      item: "Program descriptions (Healthcare, Feeding, Education)",
      status: "pending",
    },
    {
      id: "5",
      category: "Content",
      item: "Gallery images and descriptions",
      status: "pending",
    },
    {
      id: "6",
      category: "Content",
      item: "Testimonials authenticity",
      status: "pending",
    },
    ...
    // Functionality Review
    {
      ...
      item: "Daily giving donation buttons (16¢, 33¢, 50¢, 66¢) work correctly",
      status: "pending",
    },
    {
      id: "7",
      category: "Functionality",
      item: "Custom amount donation functionality",
      status: "pending",
    },
    {
      id: "8",
    ...
    },
    {
      id: "9",
      category: "Functionality",
      item: "Gallery filtering and image viewing",
      status: "pending",
    },
    {
      id: "10",
      category: "Functionality",
      item: "Navigation menu on all devices",
      status: "pending",
    },
    {
      id: "11",
      category: "Functionality",
      item: "Video background playback",
      status: "pending",
    },
    ...
    // Design Review
    {
      id: "11",
      category: "Design",
      item: "Logo and branding consistency",
      status: "pending",
    },
    {
      id: "12",
      category: "Design",
      item: "Color scheme and visual appeal",
      status: "pending",
    },
    {
      id: "13",
    ...
    },
    {
      id: "16",
      category: "Accuracy",
      item: "Statistics and impact numbers",
      status: "pending",
    },
    {
      id: "17",
      category: "Accuracy",
      item: "Program details and descriptions",
      status: "pending",
    },
    {
      id: "18",
      category: "Accuracy",
      item: "Team member information",
      status: "pending",
    },
  ]);
  ...
  const categories = Array.from(
    new Set(reviewItems.map((item) => item.category)),
  );
  const stats = {
    ...
    needsRevision: reviewItems.filter(
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Please review each section of the website and provide feedback. This
            will help ensure everything is accurate before going live.
          </p>
        </div>
                  ...
                  .map((item) => (
                    <div key={item.id} className="border rounded-lg p-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() =>
                            updateReviewStatus(item.id, "approved")
                          }
        ...
        {stats.approved === stats.total && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
            ...
            <p className="text-green-700 mb-4">
              Congratulations! The website has been fully reviewed and approved
              by the team. It's ready for production deployment.
            </p>
