...
const galleryImages: GalleryImage[] = [
  // Healthcare Category
  {
    ...
    description:
      "A young child receiving vital medical care from our dedicated healthcare team. Our medical professionals provide compassionate care in a safe, child-friendly environment, ensuring proper health screening and treatment for children in our community.",
    category: "healthcare",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "HFRP healthcare professionals conducting comprehensive medical screenings in our mobile clinic. Our trained medical team provides essential blood pressure checks and health assessments to community members using modern medical equipment.",
    category: "healthcare",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Healthcare workers conducting health outreach and education in the community, providing essential medical services and health information to families in need.",
    category: "healthcare",
    date: "2024-04-13",
  },
  ...
  // Education Category
  {
    ...
    description:
      "Carefully organized school supplies including notebooks, textbooks, pencils, and educational materials being prepared for distribution to students. Our education program ensures every child has the tools they need to succeed in school.",
    category: "education",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Community members coming together for support services and programs. These gatherings strengthen community bonds and ensure everyone has access to HFRP resources.",
    category: "education",
    date: "2024-04-13",
  },
  ...
  // Feeding Programs Category
  {
    ...
    description:
      "Community volunteers preparing traditional Haitian soup in large quantities for our feeding program. The rich, nutritious soup with vegetables and proteins provides essential nutrition for families in need.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "A distinguished community leader in formal attire overseeing food preparation operations. This demonstrates the community leadership and dedication that makes our feeding programs successful and sustainable.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Our outdoor cooking facility where we prepare large quantities of rice and other staple foods. The traditional cooking methods using large metal pots ensure we can feed entire communities.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Close-up view of traditional Haitian rice and beans (diri ak pwa) being prepared in our community kitchen. This nutritious, protein-rich meal is a staple of our feeding program.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Overhead view of our food preparation and distribution area showing the organized efforts of our team. Community members work together to prepare and distribute meals.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Using traditional cooking methods and large-capacity equipment to prepare authentic Haitian meals for community feeding programs, maintaining cultural food traditions.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Children patiently waiting in our covered outdoor dining area for their community meal. This organized feeding program serves dozens of children daily, providing nutrition and a safe community space.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "HFRP team members and community beneficiaries gathering for a group photo outside our community center. This shows the diversity of ages and backgrounds we serve, all part of our extended HFRP family.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Multiple generations of community members benefiting from HFRP programs, showing the far-reaching impact of our work across all age groups in the communities we serve.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Our daily feeding program in action, serving nutritious meals to community members of all ages. The organized system ensures everyone receives proper nutrition while maintaining dignity.",
    category: "feeding",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Fresh, hot meals being served to community members through our feeding program. Each meal is carefully prepared to provide balanced nutrition, helping combat malnutrition and food insecurity.",
    category: "feeding",
    date: "2024-04-13",
  },
  ...
  // Housing Category
  {
    ...
    description:
      "Behind-the-scenes look at our community kitchen where meals are prepared with care and attention to nutrition. Our kitchen facilities enable us to serve hundreds of community members daily.",
    category: "housing",
    date: "2024-04-13",
  },
  {
    ...
    description:
      "Daily activities and programs taking place at our community center, providing a safe and supportive environment for families and children to access essential services.",
    category: "housing",
    date: "2024-04-13",
  },
];
    ...
    const stats = categories.reduce(
      (acc, cat) => {
        if (cat.id === "all") {
          ...
          acc[cat.id] = galleryImages.filter(
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Authentic documentation of the Haitian Family Relief Project's work
            in April 2024. Every photo shows real families, real programs, and
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center">
          <div className="bg-blue-50 rounded-xl p-6 max-w-3xl mx-auto">
            ...
            <p className="text-blue-800 mb-4">
              All photos in this archive were taken during our April 2024
              program activities in Haiti. These images represent authentic,
              unedited documentation of our ongoing work.
            </p>
