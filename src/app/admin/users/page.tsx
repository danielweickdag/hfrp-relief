      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            You need to be logged in to access the user management page.
          </p>
          <Link
            href="/admin"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Manage admins, editors, and volunteers</p>
          </div>
          <Link
            href="/admin"
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    You have limited access to this section. Contact a super admin for full access.
                  </p>
                </div>
              </div>
            </div>
