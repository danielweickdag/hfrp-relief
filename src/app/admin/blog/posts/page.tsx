      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 flex items-center gap-3">
            <a href="/assistant?mode=blog" className="inline-flex items-center bg-sky-600 text-white px-3 py-2 rounded hover:bg-sky-700">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6l4 2M12 4a8 8 0 100 16 8 8 0 000-16z" />
              </svg>
              Open Blog Assistant
            </a>
            <a href="/admin" className="text-blue-600 hover:underline inline-flex items-center">
              ← Back to Admin Dashboard
            </a>
          </div>
        </div>
