  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Breadcrumb */}
        <nav className="mb-8">
          <Link href="/impact" className="text-orange-600 hover:text-orange-700">
            ← Back to Our Impact
          </Link>
        </nav>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Combating hunger and malnutrition through nutritious meals, community kitchens,
            and sustainable food programs across Haiti.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Our feeding program goes beyond simply providing meals. We focus on nutrition education,
              community empowerment, and sustainable food systems that help families become self-sufficient
              while ensuring no child goes hungry.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-orange-600 mb-3">Daily Services</h3>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Hot, nutritious meals for children and families</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Traditional Haitian cuisine with balanced nutrition</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Special dietary accommodations for medical needs</span>
                  </li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-orange-600 mb-3">Community Programs</h3>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Cooking classes and nutrition education</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Community garden development</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-2">✓</span>
                    <span className="text-gray-700">Emergency food distribution during crises</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Impact Stories</h2>
            <div className="bg-orange-50 border-l-4 border-orange-400 p-6 rounded">
              <p className="text-gray-700 italic mb-4">
                "Before HFRP's feeding program, my children often went to bed hungry. Now they have
                nutritious meals every day, and I've learned how to prepare healthy food for my family.
                My youngest daughter has grown so much stronger."
              </p>
              <p className="text-orange-600 font-semibold">— Marie, Mother of 4 from Port-au-Prince</p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-700 mb-6">
              Your support directly feeds hungry families in Haiti. Every donation helps us provide more meals,
              expand our community kitchens, and teach sustainable nutrition practices.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                <div className="text-2xl font-bold text-orange-600 mb-2">$0.50</div>
                <div className="text-sm text-gray-600">Provides one nutritious meal</div>
              </div>
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                <div className="text-2xl font-bold text-orange-600 mb-2">$15</div>
                <div className="text-sm text-gray-600">Feeds a child for one month</div>
              </div>
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                <div className="text-2xl font-bold text-orange-600 mb-2">$50</div>
                <div className="text-sm text-gray-600">Supports a family of 4 for one month</div>
              </div>
            </div>
          </section>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-lg shadow-xl p-8 text-white">
            <h2 className="text-2xl font-bold mb-4">Help Us Feed More Families</h2>
            <p className="mb-6">Join our mission to end hunger in Haiti, one meal at a time.</p>
